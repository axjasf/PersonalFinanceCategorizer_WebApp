...
def main():
    ...
    parser.add_argument("--avg-splits", type=float, default=2, help="Average number of splits per transaction")
    parser.add_argument("--max-splits", type=int, default=5, help="Maximum number of splits per transaction")
