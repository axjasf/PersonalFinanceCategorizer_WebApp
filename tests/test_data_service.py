...
def test_create_account(setup_database):
    ...
    ), f"Expected (success, message, bank_identifier), got {result}"
    ...
    assert (
        returned_bank_identifier == unique_identifier
    ), f"Bank identifier mismatch: expected {unique_identifier}, got {returned_bank_identifier}"
    ...
    assert (
        returned_bank_identifier == different_identifier
    ), f"Bank identifier mismatch: expected {different_identifier}, got {returned_bank_identifier}"
